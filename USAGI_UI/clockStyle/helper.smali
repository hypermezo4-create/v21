...
.class public final Lspider/ui/helper;
...
.method public static DynamicIsland()Z
    .registers 4

    const-string v0, "dynamic_island"

    const/4 v1, 0x1

    invoke-static {v0, v1}, Lspider/ui/helper;->getIntofSettings(Ljava/lang/String;I)I
...
.method public static DynamicIslandBool()I
    .registers 4

    invoke-static {}, Lspider/ui/helper;->IosDynamicIsland()Z

    move-result v0

    if-eqz v0, :cond_d

    const-string v0, "bool/check_is_default_strong_toast"

    invoke-static {v0}, Lspider/ui/helper;->getIdentifier(Ljava/lang/String;)I
    ...
    :cond_d
    const-string/jumbo v0, "bool/support_strong_toast"
...
.method public static DynamicIslandLayout()I
    .registers 4
    ...
    const-string v0, "layout/DynamicIsland"
    ...
    :cond_d
    const-string v0, "layout/miui_strong_toast"
...
.method public static GetMaxNotfiIcons()I
    .registers 3

    const-string v0, "notfi_icons_count"
...
.method public static IosDynamicIsland()Z
    .registers 4

    const-string v0, "ios_dynamic_island"
...
.method public static getAnimId(I)I
    ...
    invoke-static {v4}, Lspider/ui/helper;->getStringofSettings(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {}, Lspider/ui/helper;->getCon()Landroid/content/Context;
...
.method public static getBoolofSettings(Ljava/lang/String;)Z
    ...
    invoke-static {}, Lspider/ui/helper;->getCR()Landroid/content/ContentResolver;
...
.method private static getCR()Landroid/content/ContentResolver;
    ...
    sget-object v0, Lspider/ui/helper;->sCR:Landroid/content/ContentResolver;
    ...
    sput-object v0, Lspider/ui/helper;->sCR:Landroid/content/ContentResolver;
...
.method public static getCon()Landroid/content/Context;
    ...
    sget-object v0, Lspider/ui/helper;->sCon:Landroid/content/Context;

    if-nez v0, :cond_a

    invoke-static {}, Lspider/ui/helper;->createContext()Landroid/content/Context;

    move-result-object v0

    sput-object v0, Lspider/ui/helper;->sCon:Landroid/content/Context;
