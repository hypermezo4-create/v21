...
LP_HEADER_FLAG_VIRTUAL_AB_DEVICE = (1 << 0)
...
def build_header_flag_string(flags: int) -> str:
    return "virtual_ab_device" if (flags & LP_HEADER_FLAG_VIRTUAL_AB_DEVICE) else "none"
    ...
    def _get_info(self) -> Dict:
        ...
        try:
            result = {
                ...
                "header_flags": build_header_flag_string(self.header.flags),
                "block_devices": [
                    {
...
class LpUnpack:
    ...
    def _read_metadata_header(self, metadata: Metadata):
        ...
        for index, offset in enumerate(offsets):
            ...
            header.flags = struct.unpack("<I", self._fd.read(4))[0]
